...
#define CS_SETOUT() TRISBbits.TRISB15 = 0 
#define CS_LOW()  LATBbits.LATB15 = 0	//MMC CS = L
#define CS_HIGH() LATBbits.LATB15 = 1	//MMC CS = H
...
void power_on (void)
{
    ...
    TRISBbits.TRISB8 = 1; // Set RB3 as input because it's SDI1
    TRISBbits.TRISB11 = 0;
